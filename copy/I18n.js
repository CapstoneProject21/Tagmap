//the data copy is from the hotspot and main webpage menu items
...
const translations = {
  en: {
    hello: 'Hello',
    hotspots: {
      title: 'Kiran', //this is the part we need to translate or change from Hotspot to the userID
    },
    blocks: {
      title: 'BOKAAA', //this is the part we need to translate or change from Blocks to the tags
      block: 'Block',
    },
    tooltips: {
      distance:
